# XPay Labs（简称 xpay）Java SDK — 自托管加密货币支付网关 Java 开发包

[English](README.md) | 中文

**XPay Labs（简称 xpay）Java SDK** 是 [XPay Labs (xpay)](https://www.xpaylabs.com) 自托管、非托管加密货币支付网关的官方 Java 客户端。支持在 TRON (TRC20)、20+ EVM 链（Ethereum、BNB Chain、Polygon、Arbitrum、Optimism、Base）和 SUI 上接收 USDT/USDC 支付，零网关手续费。
